...
export const loadList = ({ options = { reload: false }} = {}) =>
...
export const loadListAddSucceed = (data = {}) => ({ type: LOAD_LIST_ADD_SUCCEED, data });
export const loadListAddFailed = error => ({ type: LOAD_LIST_ADD_FAILED, error });

export const loadListAdd = ({ id, text, options = { reload: false }} = {}) =>
  async (dispatch, getState) => {
